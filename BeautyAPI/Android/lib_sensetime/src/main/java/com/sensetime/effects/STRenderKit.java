...
import com.sensetime.effects.processor.IBeautyProcessor;
import com.sensetime.effects.processor.IBeautyProcessorKt;
import com.sensetime.effects.processor.InputInfo;
import com.sensetime.effects.processor.OutputInfo;
...
import com.sensetime.effects.utils.STUtils;
...
public class STRenderKit {
    ...
    public STRenderKit(Context context) {
        mContext = context;
        init();
    }
    ...
    private void initHumanAction() {
        ...
        new Thread(() -> {
            synchronized (mHumanActionHandleLock) {
                ...
                result = mStAnimalNative.createInstanceFromAssetFile(FileUtils.MODEL_NAME_CATFACE_CORE, STCommonNative.ST_MOBILE_TRACKING_MULTI_THREAD, mContext.getAssets());
                LogUtils.i(TAG, "create cat model result: %d", result);
                result = mStAnimalNative.addSubModelFromAssetFile(FileUtils.MODEL_NAME_DOG, mContext.getAssets());
