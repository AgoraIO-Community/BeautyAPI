...
> **重要说明：** 本 Demo 中的美颜 SDK 是通过脚本自动下载的，仅用于演示目的。在实际项目中，请根据业务需求选择合适的美颜 SDK。
...
> 
> - **SDK 集成方式**：将商汤美颜 SDK 的 `.aar` 文件放置在 `lib_sensetime/libs/` 对应子目录下：
>   - `HardwareBuffer/HardwareBuffer-release.aar`
>   - `SenseArSourceManager/SenseArSourceManager-release.aar`
>   - `STMobileJNI/STMobileJNI-release.aar`
> 
...
> - 在 [app/build.gradle](app/build.gradle) 里配置证书对应的包名 applicationId
> 
> - **SDK 集成方式**：通过 `lib_faceunity/build.gradle` 文件中的依赖配置
> 
> - 将相芯美颜资源放入对应路径下
...
> - 在 [app/build.gradle](app/build.gradle) 里配置证书对应的包名 applicationId
> 
> - **SDK 集成方式**：将字节火山美颜 SDK 的 `.aar` 文件放置在 `lib_bytedance/libs/` 对应子目录下：
>   - `EffectAAR/effectAAR-release.aar`
> 
> - 修改 [ByteDanceBeautySDK.kt](app/src/main/java/io/agora/beautyapi/demo/module/bytedance/ByteDanceBeautySDK.kt) 文件里 LICENSE_NAME 为申请到的证书文件名
> 
...
> **重要提醒：** 本 Demo 中的美颜 SDK 仅用于演示，实际项目集成时请使用官方提供的正式版本 SDK。
> 
