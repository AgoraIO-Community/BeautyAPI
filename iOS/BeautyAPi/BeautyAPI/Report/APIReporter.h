...
typedef NS_ENUM(NSInteger, APICostEvent) {
    APICostEventChannelUsage = 0, //Channel usage is time-consuming.
    APICostEventFirstFrameActual,  //The first frame actually takes time
    APICostEventFirstFramePerceived //The first frame is time-consuming.
};
